package com.example.uisampleapplication
...
class MainActivity : AppCompatActivity() {
     ...
     */
    private fun display() {
        val order = findViewById<Button>(R.id.button_order) // order button
        ...
        val whippedCream = findViewById<CheckBox>(R.id.whipped_cream_checkbox)
        whippedCream.isChecked = hasWhippedCream
        // Set chocolate or not
        val chocolate = findViewById<CheckBox>(R.id.chocolate_checkbox)
